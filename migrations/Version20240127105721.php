 ...
 */
final class Version20240127105721 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Sprint database schema';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trello_card ADD sprint_id INT DEFAULT NULL, ADD story_points DOUBLE PRECISION DEFAULT NULL');
