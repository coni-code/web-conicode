 ...
 */
final class Version20240127123227 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Prepare database structure for sprint';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sprint_user ADD CONSTRAINT FK_B65179658C24077B FOREIGN KEY (sprint_id) REFERENCES sprint (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sprint_user ADD CONSTRAINT FK_B6517965A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
